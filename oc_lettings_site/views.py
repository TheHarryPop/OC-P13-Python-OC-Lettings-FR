...
def letting(request, letting_id):
    instanced_letting = Letting.objects.get(id=letting_id)
    context = {
        'title': instanced_letting.title,
        'address': instanced_letting.address,
    }
...
def profile(request, username):
    instanced_profile = Profile.objects.get(user__username=username)
    context = {'profile': instanced_profile}
